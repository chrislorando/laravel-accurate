...
use ChrisLorando\LaravelAccurate\Http\Resources\SalesReturnResource;
...
class LaravelAccurate implements Arrayable
{
    ...
    public function resource(string $name): Resource
    {
        ...
        return match ($name) {
            ...
            'sales-invoice' => new SalesInvoiceResource($api),
            'sales-quotation' => new SalesQuotationResource($api),
            'sales-return' => new SalesReturnResource($api),
    ...
    /**
     * Convenience shortcut for ->resource('sales-invoice').
     */
    public function salesInvoices(): SalesInvoiceResource
    {
        return new SalesInvoiceResource($this->client());
    }
    ...
    {
        return new SalesReturnResource($this->client());
    }
